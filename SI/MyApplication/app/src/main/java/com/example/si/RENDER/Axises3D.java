...
//    };
    ...
    float[] xyzVertices = new float[]{
            ...
            1.0f, 0f, 0f,//1 X轴的终点
            0.95f, 0.05f, 0f,//2 X轴箭头1
            0.95f, -0.05f, 0f,//3 X轴箭头2

            0f, 0f, 0f,//Y轴起点
            0f, 1.0f, 0f,//Y轴终点
            0.05f ,0.95f ,0f,//Y轴箭头1
            -0.05f ,0.95f ,0f,//Y轴箭头2

            0f, 0f, 0f,//Z轴起点

            0f, 0f, 1.0f,//Z轴终点
            0f ,0.05f ,0.95f,//Z轴箭头1
            0f ,-0.05f ,0.95f,//Z轴箭头2,


            0.8f,0f,0.05f,//12 绘制字X
            0.82f,0.02f,0.05f,//13
            0.78f,0.02f,0.05f,//14
            0.78f,-0.02f,0.05f,//15
            0.82f,-0.02f,0.05f,//16

            0f,0.7f,0.05f,//17 绘制字Y
            0f,0.68f,0.05f,//18
            0.02f,0.72f,0.05f,//19
            -0.02f,0.72f,0.05f,//20

            -0f ,0.02f ,0.7f,//21  绘制字Z
            0.04f,0.02f,0.7f,//22
            -0f,-0.02f,0.7f,//23
            0.04f,-0.02f,0.7f,//24
